<?php
    ...
    return array(
         ...
         */
        'CLIENT_AUTOEXTRACT'               => get_env_bool('CLIENT_AUTOEXTRACT', true),
         ...
         */
        'CLIENT_ENABLESEARCH'               => get_env_bool('CLIENT_ENABLESEARCH', false),
         ...
         */
        'COMPRESSION_ENABLED'        => get_env_bool('COMPRESSION_ENABLED', false),
         ...
         */
        'CACHE_ENABLED'               => get_env_bool('CACHE_ENABLED', false),
         ...
         */
        'MISSING_LOG_ENABLED'        => get_env_bool('MISSING_LOG_ENABLED', false),
         ...
         */
        'PATH_MAPPING_ENABLED'       => get_env_bool('PATH_MAPPING_ENABLED', true),
         ...
         * it's recommended to disable this feature.
         */
        'WARM_CACHE_ENABLED'         => get_env_bool('WARM_CACHE_ENABLED', false),
         ...
         * it's recommended to disable this feature.
         */
        'INDEX_CACHE_ENABLED'        => get_env_bool('INDEX_CACHE_ENABLED', false),
